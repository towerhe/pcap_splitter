...
func main() {
  ...
  fmt.Println("-------------------------------------------------------------\n")
  fmt.Println("Source File: ", *toBeSplitted)
  fmt.Println("Destination Directory: ", *dstDir)
  fmt.Println("Size of Segments: ", *sizeOfSeg, "KB\n")
  fmt.Println("-------------------------------------------------------------\n")
  ...
  for err == nil {
      ...
      fmt.Printf("Segment { name: %s, size: %d }  CREATED\n", dstFile.Name(), fileSize)
